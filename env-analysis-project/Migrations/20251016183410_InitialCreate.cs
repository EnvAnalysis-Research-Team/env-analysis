...
namespace env_analysis_project.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Domain tables from AddDomainTables migration
            migrationBuilder.CreateTable(
                name: "Parameter",
                columns: table => new
                {
        ...
        {
            // Drop domain tables first (respecting FK order)
            migrationBuilder.DropTable(name: "MeasurementResult");
            migrationBuilder.DropTable(name: "EmissionSource");
            migrationBuilder.DropTable(name: "SourceType");
            migrationBuilder.DropTable(name: "Parameter");

            // Then drop identity tables
